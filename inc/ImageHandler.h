...
public: // Constructors and destructor
        ...
        */
        static CImageHandler* NewL(CFbsBitmap* aBitmap, MImageHandlerCallback& aCallback);
        ...
        * @return pointer to created CImageHandler-object
        */
        static CImageHandler* NewLC(CFbsBitmap* aBitmap, MImageHandlerCallback& aCallback);
       /**
...
public: // New functions
         ...
         */
        TBool SetBitmap(CFbsBitmap *aBitmap);
         ...
         */
        void LoadFileL(RFs& aFs, const TFileName& aFileName, TInt aSelectedFrame = 0);
         ...
         */
        void LoadFileAndScaleL(RFs& aFs, const TFileName& aFileName,
                               const TSize &aSize,
